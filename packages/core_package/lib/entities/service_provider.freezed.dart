    ...
    return _then(_value.copyWith(
      ...
      userRef: null == userRef
          ...
          : userRef // ignore: cast_nullable_to_non_nullable
              as String,
      publicPicture: freezed == publicPicture
...
class _$_ServiceProvider implements _ServiceProvider {
  ...
  @override
  String toString() {
    return 'ServiceProvider(id: $id, collectionId: $collectionId, collectionName: $collectionName, userRef: $userRef, publicPicture: $publicPicture, publicName: $publicName, isPublic: $isPublic, created: $created, updated: $updated)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, collectionId, collectionName,
      userRef, publicPicture, publicName, isPublic, created, updated);
