...
class _$_CreateUserParams implements _CreateUserParams {
  ...
  @override
  String toString() {
    return 'CreateUserParams(username: $username, email: $email, emailVisibility: $emailVisibility, password: $password, passwordConfirm: $passwordConfirm, firstName: $firstName, lastName: $lastName, type: $type, isActive: $isActive)';
  }
